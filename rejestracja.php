...
<br><br><br>
           <form method="post" action="register.php">
            ...
            <form class="user">           
                ...
                <div class="form-group">
                  <input id="User_haslo" name="haslo1" type="password" required="" placeholder="haslo" class="form-control form-control-user">
                </div>

                
                <div class="form-group">
                  <button type="submit" name="" class="btn btn-success">Zarejestruj się!</button>
