...
<br><br><br>
            ...
            <a href="aku.php"><img src="img/aku.png" style="position: relative; right: 120px; top: 15px" height="25%" width="25%"></a>
            <a href="zar.php"> <img src="img/zar.png" style="position: relative; right: 120px; top: 15px" height="25%" width="25%"></a>
            <a href="turbo.php"> <img src="img/turbo.png" style="position: relative; right: 120px; top: 15px" height="25%" width="25%"></a>
